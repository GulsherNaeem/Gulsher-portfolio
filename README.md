# [<img src="docs/assets/logo.png"> WordpressPortfolio](https://gulshernaeem.github.io/react-portfolio-template/) by Gulsher Naeem
...
|-------|---------------------|---------------------------------------------------------|-------------------------------------------------------------------------|
| 🟢    | Gulsher Naeem (default) | Latest deployment of the template here on GitHub pages. | [Preview](https://gulshernaeem.github.io/react-portfolio-template/)     |
...
1. Clone the repo:
```
git clone https://github.com/gulshernaeem/react-portfolio-template
```
...
This template was created by and is maintained by **[Gulsher Naeem](https://gulshernaeem.com/)**.

It's based on the **[React](https://reactjs.org/)** framework created by Jordan Walke, and the **[Bootstrap](https://getbootstrap.com/)** framework created by GulsherOtto and Jacob Thorton.
